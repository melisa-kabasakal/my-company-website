  ...
  return (
    <section id="contact" className="py-32 px-6 relative" data-animate>
      <div className="max-w-5xl mx-auto">
        ...
        <div
          className={`relative p-10 rounded-3xl bg-gradient-to-br from-gray-900/50 to-black/50 border border-gray-800/50 backdrop-blur-sm overflow-hidden transition-all duration-1000 ${
            isVisible.contact
